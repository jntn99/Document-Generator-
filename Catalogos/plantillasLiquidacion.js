const plantillasLiquidacion = {
  ...
  metalesFisicos: [
    {
      id: "PLANTILLA_METAL_AU",
      nombre: "Oro Fisico",
      tipoOperacion: "METAL_FISICO",
      metalId: "AU",
      elementos: ["AU"],
      presentacionesPermitidas: ["LINGOTE", "PEPAS", "GRANALLA", "POLVO", "SCRAP", "OTRO"],
      unidadPeso: "gr",
      unidadPureza: "%",
    ...
    {
      id: "PLANTILLA_METAL_AG",
      nombre: "Plata Fisica",
      tipoOperacion: "METAL_FISICO",
      metalId: "AG",
      elementos: ["AG"],
      presentacionesPermitidas: ["GRANALLA", "LINGOTE", "PEPAS", "POLVO", "SCRAP", "OTRO"],
      unidadPeso: "gr",
      unidadPureza: "%",
      unidadCotizacion: "O.T.",
      usaPesos: true,
    ...
    {
      id: "PLANTILLA_METAL_SN",
      nombre: "Estano Fisico",
      tipoOperacion: "METAL_FISICO",
      metalId: "SN",
      elementos: ["SN"],
      presentacionesPermitidas: ["LINGOTE", "GRANALLA", "POLVO", "SCRAP", "OTRO"],
      unidadPeso: "gr",
      unidadPureza: "%",
      unidadCotizacion: "TM",
      usaPesos: true,
